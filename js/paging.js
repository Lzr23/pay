	...
	Paging.prototype = {
		...
		createDom: function() {
			...
			for(var i = 1; i <= that.options.totalPages; i++) {
				i != 1 ? ulDom += '<li><a style="display:block;width:100%;height:100%" href="#">' + i + '</a></li>' : ulDom += '<li class="sel-page"><a style="display:block;width:100%;height:100%" href="#">' + i + '</a></li>';
			}
			...
			content = '<div class="pagination-left"><p class="total-pages">共&nbsp;' +
				that.options.totalPages +
				'&nbsp;页</p>' +
				'<p class="total-count">' +
				that.options.totalCount +
				'</p></div>'+
				'<div class="pagination-right"><a href="#" type="button" id="firstPage" class="turnPage first-page">首页</a>' +
				'<a href="#" class="turnPage" id="prePage">上一页</a>' +
